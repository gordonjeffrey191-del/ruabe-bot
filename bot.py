...
FAQ_ITEMS = [
    {"id": "reject_reason", "button": "Что может стать причиной отказа?", "question": "Что может стать причиной отказа?", "answer": "Причиной отказа могут стать подозрительное поведение, неадекватные ответы в анкете, нарушение правил ещё до вступления, серьёзные нарушения в прошлых чатах сообщества или явное несоответствие атмосфере сообщества."},
    {"id": "why_application", "button": "Зачем нужна заявка?", "question": "Зачем нужна заявка на вступление?", "answer": "Заявка нужна для того, чтобы снизить количество случайных, конфликтных или вредоносных участников и сохранить комфортную атмосферу в сообществе."},
    {"id": "review_time", "button": "Сколько рассматривается заявка?", "question": "Сколько обычно рассматривается заявка?", "answer": "Обычно заявки рассматриваются довольно быстро, но точное время зависит от активности администрации."},
    {"id": "new_account", "button": "Можно ли использовать новый аккаунт?", "question": "Можно ли использовать анонимный/новый аккаунт?", "answer": "Да, использование анонимных или новых аккаунтов допускается, однако администрация может уделять таким аккаунтам больше внимания."},
    {"id": "hide_age", "button": "Можно ли скрывать возраст?", "question": "Можно ли скрывать возраст?", "answer": "Да, вы не обязаны раскрывать свой реальный возраст. Однако чат предназначен только для лиц старше 16 лет. Если администрации станет известно, что участнику меньше 16 лет, он будет заблокирован без возможности апелляции."},
    {"id": "sfw", "button": "Чат только для SFW-тем?", "question": "Чат ориентирован только на SFW-тематику?", "answer": "Нет. В чате присутствуют разные темы общения, включая отдельный подчат 18+ для обсуждения NSFW-тематики. Однако даже в нём запрещена публикация порнографии, в том числе в частично скрытом или зацензуренном виде."},
    {"id": "activity", "button": "Насколько важна активность?", "question": "Насколько важна активность новичков?", "answer": "Чат ориентирован на живое общение, поэтому активность новых участников приветствуется и ценится."},
    {"id": "read_only", "button": "Можно ли просто читать чат?", "question": "Можно ли просто читать чат?", "answer": "Постоянное нахождение исключительно в роли наблюдателя не приветствуется. Сообщество строится вокруг активного участия в общении."},
    {"id": "chat_active", "button": "Насколько чат активный?", "question": "Насколько чат активный?", "answer": "Активность зависит от времени суток и дней недели, но в чате регулярно происходят обсуждения и общение."},
    {"id": "conflict", "button": "Что делать при конфликте?", "question": "Что делать, если возник конфликт с участником?", "answer": "Рекомендуется не усугублять конфликт и обратиться к администрации при необходимости."},
    {"id": "rules_violation", "button": "Что делать при нарушениях?", "question": "Что делать, если кто-то нарушает правила?", "answer": "Сообщите об этом администрации и по возможности приложите контекст ситуации."},
    {"id": "nick_avatar", "button": "Есть ли ограничения на ник и аватар?", "question": "Есть ли ограничения на никнеймы и аватарки?", "answer": "Да. Никнеймы и аватарки не должны нарушать правила сообщества или содержать запрещённый контент."},
    {"id": "country", "button": "Есть ли ограничения по стране?", "question": "Есть ли ограничения по стране проживания?", "answer": "Нет, ограничений по стране проживания нет."},
    {"id": "introduce", "button": "Нужно ли представляться?", "question": "Нужно ли представляться после вступления?", "answer": "Нет, это не обязательно. Однако знакомство с участниками обычно помогает быстрее влиться в общение."},
    {"id": "return_later", "button": "Можно ли уйти и вернуться позже?", "question": "Можно ли покинуть чат и вернуться позже?", "answer": "Да, в большинстве случаев повторное вступление возможно."},
    {"id": "invite_friend", "button": "Можно ли пригласить друга?", "question": "Можно ли пригласить друга?", "answer": "Обычно да, однако приглашённый участник также должен пройти одобрение через бота."},
    {"id": "subchats", "button": "Есть ли отдельные подчаты?", "question": "Есть ли в чате подтемы и отдельные подчаты?", "answer": "Да. В сообществе присутствуют отдельные подчаты для разных тем и форматов общения."},
    {"id": "dating_section", "button": "Есть ли раздел знакомств?", "question": "Есть ли в чате раздел знакомств?", "answer": "Да, в сообществе присутствует отдельный подчат для знакомств."},
    {"id": "creative", "button": "Есть ли раздел творчества?", "question": "Есть ли раздел для творчества и артов?", "answer": "Да, участники могут делиться своим творчеством и работами в соответствующих разделах сообщества."},
    {"id": "personal_problems", "button": "Можно ли обсуждать личные проблемы?", "question": "Можно ли обсуждать личные проблемы?", "answer": "Да, если обсуждение остаётся в рамках правил и уважительного общения."},
    {"id": "discord", "button": "Есть ли Discord чата?", "question": "Есть ли у сообщества Discord или другие платформы?", "answer": "Да. У сообщества есть официальный Discord-сервер, где участники проводят совместные активности, ивенты и общаются на дополнительные темы."},
    {"id": "without_reddit", "button": "Можно ли попасть без Reddit?", "question": "Можно ли попасть в чат без Reddit?", "answer": "Да, наличие Reddit-аккаунта не является обязательным условием для вступления."},
]
